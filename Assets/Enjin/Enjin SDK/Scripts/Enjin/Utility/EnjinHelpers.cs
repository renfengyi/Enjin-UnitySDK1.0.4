namespace EnjinSDK.Helpers
{
    ...
    public class EnjinHelpers
    {
        ...
        public static string IntToBoolString(int num) { return (num == 1) ? "True" : "False"; }
        ...
        public static string GetJSONString(string str, int levels) { return GetJSONString(str, ':', levels); }
        ...
        public static string GetJSONString(string str) { return GetJSONString(str, ':', 2); }

        /// <summary>
        /// Generates pass code with 12 characters by default
        /// </summary>
        /// <returns>12 character pass code</returns>
        public static string GeneratePassCode() { return GeneratePassCode(12); }
        ...
        /// <summary>
        /// Processes the field data fields
        /// </summary>
        /// <param name="data">Field data to process</param>
        /// <returns>Query for processing the Field data</returns>
        private static string ProcessFieldData(Fields data)
        {
            string query = "{key:\"" + data.key + "\",value:\"" + data.value + "\",searchable:" + data.searchable.ToString() +
                ",displayable:" + data.displayable.ToString() + ",unique:" + data.unique.ToString() + "}";

            return query;
        }

        /// <summary>
        /// Gets all the field data in JSON format
        /// </summary>
        /// <param name="fields">Array of fields to get data from</param>
        /// <returns>JSON string of fields data</returns>
        public static string GetFieldsString(Fields[] fields)
        {
            ...
            {
                query += ProcessFieldData(fields[i]);
